...
function Signup() {
  ...
  return (
    <div className="min-h-screen flex justify-center items-center bg-[#f5f1ea] relative overflow-hidden">
      ...
      >
        <h1 className="text-4xl font-bold mb-8 text-center">Join Essen 🍽️</h1>
        ...
        <textarea
          ...
          required
          className="w-full border p-3 rounded-xl mb-5 outline-none resize-none"
          rows={3}
        />

        {/* BUTTON */}

        <button className="w-full bg-black text-white p-3 rounded-xl hover:bg-gray-800 transition">
          Signup
        </button>
